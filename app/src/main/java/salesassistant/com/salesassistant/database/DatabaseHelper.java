...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void importInitialData(SQLiteDatabase db) {
        ...
        Product p1 = new Product("Palitos da Gina", "Gina CIA de Palitos LTDA");
        Product p2 = new Product("Farinha de Trigo da Terra", "Moinho Vera Cruz S.A.");
        Product p3 = new Product("Cerveja Golaço", "Bebitas Blerg LTDA");
        Product p4 = new Product("Leite da Vaca", "Laticínios Fazenda Belo Brejo LTDA");
        Product p5 = new Product("Arroz Tio Ubirajara", "Cereais Ubirajara S.A.");
        Product p6 = new Product("Caninha 29", "Alambique do Pedro LTDA");
